            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <img src="{{ asset('/images/indigenous-desktop-screenshot.png') }}"
                                 alt="IndiePass on Desktop" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="features" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>Context menu: right click when selecting text to search DuckDuckGo, or save an image, or
                            copy the link and so on.
                        </li>
            ...
            <p class="pt-5">Found an issue with the app or have any feedback or suggestions? Raise an issue <a
                    href="https://github.com/indiepass/indigenous-desktop/issues">on GitHub</a>.</p>
        </div>
        </div>
        </div>
    </section>
